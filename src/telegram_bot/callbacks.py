...
async def handle_about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    about_text = (
        ...
        "Spanish, French, Italian, Portuguese, German, English, Dutch, "
        "Czech, Polish, Russian, Hungarian, Arabic, Turkish, Hindi, "
        "Japanese, Korean, Mandarin (Simplified & Traditional)\n\n"
        "📖 *Dictionary & Etymology*\n"
        "Best coverage for European languages via Wiktionary\n\n"
        "🎤 *Pronunciation Scoring*\n"
        "English, French, Spanish, German, Italian, Portuguese, "
        "Russian, Polish, Japanese, Mandarin, Arabic, Turkish, Dutch\n\n"
        "📊 *Smart Synonyms (CEFR levels)*\n"
        "English, German, French, Spanish, Italian, Portuguese, Dutch, "
        "Russian, Mandarin, Japanese, Korean, Arabic\n\n"
        "🎛 *Voice Effects*\n"
        "Works with any language\n\n"
        "⚠️ _Language support varies by feature depending on the "
        "underlying services and models used._\n\n"
        "*Credits:*\n"
        "• Translations: Google Translate\n"
        "• Voice TTS: Coqui XTTS\n"
        "• Text TTS: Google TTS\n"
        "• Dictionary: Wiktionary\n"
        "• Speech Recognition: Wav2Vec2 (Meta)\n\n"
